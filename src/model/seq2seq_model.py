...
class Seq2SeqModel(object):
    ...
    def __init__(self, encoder_masks, encoder_inputs_tensor,
        ...
        def seq2seq_f(lstm_inputs, decoder_inputs, seq_length, do_decode):
            ...
            lstm_fw_cell = tf.nn.rnn_cell.LSTMCell(num_hidden, forget_bias=0.0, state_is_tuple=False, name='basic_lstm_cell')
            # Backward direction cell
            # lstm_bw_cell = tf.contrib.rnn.BasicLSTMCell(num_hidden, forget_bias=0.0, state_is_tuple=False)
            lstm_bw_cell = tf.nn.rnn_cell.LSTMCell(num_hidden, forget_bias=0.0, state_is_tuple=False, name='basic_lstm_cell')
